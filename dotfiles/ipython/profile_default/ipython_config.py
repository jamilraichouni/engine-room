...
# c.TerminalInteractiveShell.banner1 = "Python 3.10.4 (v3.10.4:9d38120e33, Mar 23 2022, 17:29:05) [Clang 13.0.0 (clang-1300.0.29.30)]\nType 'copyright', 'credits' or 'license' for more information\nIPython 8.3.0 -- An enhanced Interactive Python. Type '?' for help.\n"
...
ENV_DIR = pathlib.Path.home()
sys.path.insert(0, str(ENV_DIR))

from pygmentsstyles import VSCodeDarkStyle as MyStyle
...
# c.TerminalInteractiveShell.pdb = False  # do not set to True when using pdb++
