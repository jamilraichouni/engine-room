...
for F in /etc/zshenv /etc/zprofile /etc/zshrc; do [[ -f $F ]]  && sudo mv $F{,.bak}; done

# environment variables
sudo ln -s ~/engine-room/dotfiles/zsh/env/ALL_HOSTS.zsh /etc/zshenv
# login zsh configuration
sudo ln -s ~/engine-room/dotfiles/zsh/profile/ALL_HOSTS.zsh /etc/zprofile
# interactive zsh configuration
sudo ln -s ~/engine-room/dotfiles/zsh/interactive/ALL_HOSTS.zsh /etc/zshrc
